...
Tant que je n'ai pas de données d'instruction COMMIT (Pour publier) ou bien ROLLBACK (Annuler la transaction),
...
START TRANSACTION;
  ...
  -- Je supprime la procedure la base une fois effectuée
